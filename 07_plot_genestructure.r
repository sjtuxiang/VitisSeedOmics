...
gene_family <- read.table(
  "gene_family.txt",
  header = FALSE,
  sep = "\t"
)

fam_class <- read.table(
  "family.freq_class.txt",
  header = FALSE,
  sep = "\t"
)
...
# Convert identifiers to character strings to avoid factor-related issues
...
# =======================
# 6. Define the Wilcoxon test function
# =======================
